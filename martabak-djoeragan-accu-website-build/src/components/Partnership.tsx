...
export default function Partnership() {
  return (
    <section
      id="partnership"
      className="relative py-14 sm:py-20 md:py-28 bg-brand-secondary/30"
    >
      <div className="mx-auto max-w-[1280px] container-px">
        ...
        <div className="reveal text-center max-w-2xl mx-auto mb-10 sm:mb-14">
          ...
          <h2 className="font-heading font-extrabold text-brand-white text-[clamp(1.5rem,5vw,3rem)] leading-tight">
            Kerja Sama, Reseller{" "}
            <span className="text-brand-golden">&amp; Kemitraan</span>
          </h2>
          <p className="mt-3 sm:mt-4 text-sm sm:text-base md:text-lg text-brand-soft/70 leading-relaxed">
            Berkembang Bersama Martabak Djoeragan Accu
          </p>
        </div>

        {/* 3 Highlight cards */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 max-w-3xl mx-auto mb-10 sm:mb-14">
          {highlights.map((f, i) => (
            <div
              key={i}
