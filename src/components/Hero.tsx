    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          style={{ filter: "brightness(0.4) contrast(1.08) saturate(1.1)" }}
        />
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-[1280px] container-px pb-20 sm:pb-16 md:pb-0 pt-20 sm:pt-24 md:pt-0 w-full">
        <div className="max-w-2xl">
          {/* Label */}
          <div className="animate-fade-up inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/5 backdrop-blur-sm border border-white/10 rounded-full mb-5 sm:mb-6 md:mb-8">
          ...
          {/* Description */}
          <p
            className="animate-fade-up mt-4 sm:mt-5 md:mt-7 text-sm sm:text-base md:text-lg text-brand-soft/90 max-w-lg leading-relaxed"
          ...
          {/* CTAs */}
          <div
            className="animate-fade-up flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 sm:mt-8 md:mt-10"
          ...
          {/* Trust indicators */}
          <div
            className="animate-fade-up mt-8 sm:mt-10 md:mt-14 flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-x-6 sm:gap-y-3"
